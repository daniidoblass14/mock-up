...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-dark-950 flex">
      ...
      <div className="hidden lg:flex lg:w-2/3 relative bg-gradient-to-br from-dark-900 to-dark-950 overflow-hidden">
      ...
      <div className="w-full lg:w-1/3 bg-dark-950 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-2xl font-bold text-white">AutoLytix</h1>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-dark-900 border border-dark-800 rounded-lg pl-10 pr-4 py-3 text-white placeholder-dark-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  id="password"
                  className="w-full bg-dark-900 border border-dark-800 rounded-lg pl-10 pr-12 py-3 text-white placeholder-dark-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-dark-300">Recuérdame</span>
              </label>

      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold text-dark-900 dark:text-white">Detalle del Vehículo</h1>
          </div>
        </div>
        <button
          onClick={() => navigate('/vehiculos')}
        ...
        <div className="p-6 border-b border-gray-200 dark:border-dark-800">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="px-2 py-1 bg-gray-100 dark:bg-dark-800 rounded text-sm text-gray-600 dark:text-dark-400">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-dark-800">
                {mantenimientos.map((mantenimiento) => (
                  <tr key={mantenimiento.id} className="hover:bg-gray-50 dark:hover:bg-dark-800 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      {mantenimiento.costo ? (
                        <span className="text-dark-900 dark:text-white font-medium">{formatCurrency(mantenimiento.costo)}</span>
                      ) : (
